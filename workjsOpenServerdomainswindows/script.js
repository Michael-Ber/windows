...
var form = function form() {
  ...
  function bindPostData(formSelector) {
    ...
    form.forEach(function (form) {
      form.addEventListener('submit', function (e) {
        ...
        Object(_services_postData__WEBPACK_IMPORTED_MODULE_4__["default"])("./assets/server.php", formData).then(function (data) {
          return data.text();
        }).then(function (data) {
          console.log(data);
  ...
  function showThanksModal(parentSelector, message) {
    ...
    div.innerHTML = "\n            <div class=\"popup_content text-center\">\n                <button type=\"button\" class=\"popup_close\" data-close><strong>&times;</strong></button>\n                <h3>".concat(message, "</h3>\n            </div>\n        ");
